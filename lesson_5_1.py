...
Company = namedtuple('Company', 'name quart1 quart2 quart3 quart4 is_leader yearly')
...
for i in range(number):
    ...
    all_companies.append(Company(name, quart1, quart2, quart3, quart4, True,
...
print(f'Общая прибыль равна: {income}\nПрибыльные организации: ')
